...
4. **Implementa** siguiendo `docs/conventions.md`. No te salgas del scope
   del `acceptance` listado en el Spec (`specs/<id>_spec.md`).
...
- **Stack estricto**: Node.js 24, PNPM (nunca NPM/YARN), rutas relativas.
- **Sin dependencias innecesarias**: Verifica primero si Node.js nativo puede resolver el problema.
